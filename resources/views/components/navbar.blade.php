<nav class="flex justify-between px-52 py-7 shadow-lg border-b items-center fixed w-full z-50 bg-white">
    <a href="/">
        <h3 class="text-xl font-bold text-blue-600">Hamdi Harahap</h3>
    </a>
    <ul class="flex gap-3">
